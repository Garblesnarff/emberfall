...
const HEAT_SWEET_LO := 70.0
const HEAT_SHOT_GAIN := 4.5
const HEAT_DECAY_PER_TICK := 0.18
const SWELTER_RADIUS_BASE := 38.0
const SWELTER_RADIUS_SCALE := 100.0
const SWELTER_SLOW_BASE := 0.12
const SWELTER_SLOW_SCALE := 0.36
const SWELTER_SCORCH_DAMAGE_FACTOR := 0.03
const CHOIR_SHARED_HP := 720.0
const CHOIR_ORBIT_RADIUS := 250.0
const CHOIR_CONTACT_DAMAGE := 16.0
const CHOIR_TETHER_IDLE_MIN_TICKS := 200
const CHOIR_TETHER_IDLE_MAX_TICKS := 300
const CHOIR_TETHER_TELEGRAPH_TICKS := 40
const CHOIR_TETHER_SNAP_TICKS := 14
const CHOIR_TETHER_DAMAGE := 14.0
const CHOIR_TETHER_WIDTH := 16.0
const CHOIR_REPRISE_TICKS := 70
const CHOIR_REPRISE_CHORD_TICK := 40
const CHOIR_MOURN_SPEED := 2.2
const CHOIR_MOURN_HOMING := 0.035
const CHOIR_VESPER_SPEED := 5.4
const CHOIR_BEAT_THREE := 60
const CHOIR_BEAT_TWO := 42
const CHOIR_BEAT_ONE := 30
const AURUM_CROWN_ARMOR := 520.0
const AURUM_CORE_HP := 900.0
const AURUM_WHITE_HEAT_DAMAGE_MULT := 2.0
const AURUM_COLD_DAMAGE_MULT := 0.6
const AURUM_SIPHON_LOCK_TICKS := 36
const AURUM_SIPHON_ACTIVE_TICKS := 56
const AURUM_SIPHON_DRAIN_PER_TICK := 2.6
const AURUM_SIPHON_WIDTH := 42.0
const AURUM_GEYSER_RADIUS := 48.0
const AURUM_GEYSER_ERUPT_TICK := 46
const AURUM_GEYSER_DAMAGE := 18.0
const AURUM_FERVOR_HP_FRAC := 0.25
